...
class DefisUrl():
    def __init__(self, urlget, urlpost = None, debug = False, proxy = None) :
        self.urlget = urlget
    ...
    def get(self):
        question = requests.get(self.urlget, verify=False, proxies=self.proxies)
    ...
    def post(self,reponse):
        res = requests.post(self.urlpost, verify=False,
